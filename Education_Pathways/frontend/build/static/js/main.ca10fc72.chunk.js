  ...
  [0],
  {
    100: function (e, t, s) {
      ...
      var a = s(0),
        ...
        l = s(20),
        u = s(19),
        h = (s(66), s(47), s.p + "static/media/logo.5aff8b5f.png"),
        j = s(103),
        d = s(104),
        b = s(8),
        p = s(46),
        ...
        x = s(9),
        O = s(22),
        A = s.p + "static/media/requisite-label.488f48a1.png",
        g =
        ...
        S = (function (e) {
          ...
          function s(e) {
            ...
            return (
              Object(i.a)(this, s),
              ((a = t.call(this, e)).openLink = function () {
                var e = window.open(
                  a.state.syllabus,
                  "_blacnk",
                  "noopener,noreferrer"
            ...
            Object(o.a)(s, [
              {
                ...
                value: function () {
                  ...
                  console.log(
                    ...
                    y.a
                      .get(
                        "https://assignment-1-starter-template.herokuapp.com/course/details?code=".concat(
                          this.props.match.params.code
                        ),
                      ...
                      .then(function (t) {
                        console.log(t.data),
                          e.setState({ course_code: t.data.course.code }),
                          e.setState({ course_name: t.data.course.name }),
                          e.setState({
                            course_description: t.data.course.description,
                          }),
                          e.setState({ graph: t.data.course.graph });
                        var s = t.data.course.prereq.length;
                        if (s > 1) {
                          for (var a = "", c = 0; c < s; c++)
                            (a += t.data.course.prereq[c]),
                              c !== s - 1 && (a += ", ");
                          e.setState({ prerequisites: a });
                        } else e.setState({ prerequisites: t.data.course.prereq });
                        var r = t.data.course.coreq.length;
                        if (r > 1) {
                          for (var n = "", i = 0; i < n; i++)
                            (n += t.data.course.coreq[i]),
                              i !== r - 1 && (n += ", ");
                          e.setState({ corequisites: n });
                        } else e.setState({ corequisites: t.data.course.coreq });
                        var o = t.data.course.exclusion.length;
                        if (o > 1) {
                          for (var l = "", u = 0; u < l; u++)
                            (l += t.data.course.exclusion[u]),
                              u !== o - 1 && (l += ", ");
                          e.setState({ exclusions: l });
                        } else e.setState({ exclusions: t.data.course.exclusion });
                        var h =
                          "http://courses.skule.ca/course/" + e.props.code;
                        e.setState({ syllabus: h });
                        e.setState({ graphics: [] });
                      }),
                        ...
                        Object(v.jsxs)(O.a, {
                          children: [
                            Object(v.jsxs)(x.a, {
                              className: "col-item",
                              children: [
                                Object(v.jsx)("h3", { children: "Division" }),
                                Object(v.jsx)("p", {
                            ...
                            Object(v.jsxs)(x.a, {
                              className: "col-item",
                              children: [
                                Object(v.jsx)("h3", { children: "Department" }),
                                Object(v.jsx)("p", {
        ...
        k =
          ...
          (function (e) {
            ...
            function s(e) {
              ...
              return (
                Object(i.a)(this, s),
                ((a = t.call(this, e)).redirectCourse = function () {
                  a.props.history.push(
                    "/course/details/".concat(a.props.course_code),
                    { course_code: a.props.course_code }
                  );
                }),
                (a.state = {
                  course_code: a.props.course_code,
                  course_name: a.props.course_name,
            ...
            function s() {
              ...
              return (
                ...
                ((e = t.call(this)).getData = function (t) {
                  y.a
                    .get(
                      "https://assignment-1-starter-template.herokuapp.com/searchc?input=".concat(
                        t
                      )
                    )
                    .then(function (t) {
                      if (
                        (console.log("it is ".concat(t.status)),
                        200 === t.status)
                      )
                        if ((e.setState({ results: [] }), t.data.length > 0)) {
                          var s = t.data.length,
                            a = [];
                          a.push(Object(v.jsx)(E, {}));
                          for (var c = 0; c < s; c++)
                            a.push(
                              Object(v.jsx)(k, {
                                course_code: t.data[c].code,
                                course_name: t.data[c].name,
                              })
                            );
                          e.setState({ results: a });
                        } else if (0 === t.data.length)
                          alert("Course not found");
                        else {
                          var r = [];
                          r.push(Object(v.jsx)(E, {})),
                            r.push(
                              Object(v.jsx)(k, {
                ...
                (e.handleChange = e.handleChange.bind(Object(C.a)(e))),
      ...
      var B = (function (e) {
          ...
          function s(e) {
            ...
            return (
              Object(i.a)(this, s),
              ((a = t.call(this, e)).logOut = function () {
                    ...
                    children: [
                      Object(v.jsx)("div", {
                        children: Object(v.jsxs)(j.a, {
                          ...
                          expand: "lg",
                          children: [
                            Object(v.jsxs)(j.a.Brand, {
                              children: [
                                Object(v.jsx)("img", { src: h, alt: "" }),
                                " ",
                                Object(v.jsx)(d.a.Link, {
                                  href: "/",
                            ...
                            Object(v.jsx)(j.a.Toggle, {}),
                            Object(v.jsx)(j.a.Collapse, {
                              children: Object(v.jsx)(d.a, {
                                children: Object(v.jsx)(d.a.Link, {
                                  as: p.b,
                                  to: "/about",
                                  children: "About Us",
                                }),
                        ...
                        children: Object(v.jsxs)(b.c, {
                          children: [
                            ...
                            Object(v.jsx)(b.a, {
                              ...
                              render: function (e) {
                                return Object(v.jsx)(S, Object(n.a)({}, e));
                              },
                            }),
                            Object(v.jsx)(b.a, {
                              path: "/",
        ...
        N = s.p + "static/media/footer.e420ace1.png",
        R = function () {
          return Object(v.jsxs)("footer", {
            className: "footer",
            children: [Object(v.jsx)("img", { src: N, alt: "" }), " "],
          });
        };
      s(98);
      var q = function () {
        ...
        I = (s(99), document.getElementById("root"));
      r.a.render(Object(v.jsx)(q, {}), I);
    },
    56: function (e, t, s) {},
    65: function (e, t, s) {},
    66: function (e, t, s) {},
...
//# sourceMappingURL=main.ca10fc72.chunk.js.map
